      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            Spacer(),
            Text("Career",style: TextStyle(fontSize: 22,color: Colors.white),),
            Spacer(),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Center(child: Text("SNMM",style: TextStyle(color: Colors.grey),)),
                ),
                SizedBox(width: 8.0,),
                Container(
                  height: 30,
            ...
            Row(
              children: [
                Text("246 Vacancies",style: TextStyle(color: Colors.grey),),
                Spacer(),
                TextButton(onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder:  (context)=> Matching()));
                },
                  child: Text("By MATCHING",style: TextStyle(color: Colors.grey),),
                ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        SizedBox(width: 16.0,),
                        Text("Marketer",style: TextStyle(fontSize: 22),),
                        Spacer(),
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("From 1000 Euros",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          height: 40,
                          width: 150,
                          decoration: BoxDecoration(border: Border.all(width: (1)),borderRadius: BorderRadius.all(Radius.circular(10)),color: Colors.white,),
                          child: Center(child: Text("Reply")),
                        ),
                        SizedBox(width: 10,),
                      ],
